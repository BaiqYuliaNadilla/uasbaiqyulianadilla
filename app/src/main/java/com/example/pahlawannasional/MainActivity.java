...
public class MainActivity extends AppCompatActivity {
    ...
    com.example.pahlawannasional.DaftarPahlawanAdapter adapter;
    ...
    private void setupListview() {
        adapter = new com.example.pahlawannasional.DaftarPahlawanAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, com.example.pahlawannasional.FormPahlawanActivity.class);
        startActivity(intent);
    }

    private void changeUserName() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Gantii namaa");
